...
% Sample Experiment
%https://academic.oup.com/cercor/article/27/8/4277/3862203

%__________________________________________________________________________
function dnn_cosmo_glm_searchlight(mypath,mri,meg,mvpa,type)
...
mvpa.dnn.predictor.name = pred_cell(1,:);
...
for s = 1:nsubjs
    ...
    measure_args.analysis = mvpa.cosmo.glm.analysis.dnn;
